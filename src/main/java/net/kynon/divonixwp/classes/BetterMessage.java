package net.kynon.divonixwp.classes;
...
public class BetterMessage {
    ...
    public static String message(String message, Member member, Guild guild) {
        ...
        try {
            ...
            Map<String, Object> msgData = Main.replacePlaceholders(yaml.load(new FileInputStream("plugins/DWP/wpconfig.yml")), member, guild);
